...
@swagger_auto_schema(method='patch', request_body=ProductSerializer, responses={200: ProductSerializer, 404: 'Not Found'})
@api_view(['PATCH'])
...
# PUT (Full Update)
@swagger_auto_schema(method='put', request_body=ProductSerializer, responses={200: ProductSerializer, 404: 'Not Found'})
@api_view(['PUT'])
